 ...
 *
 *
 * The class takes Raw PCM data from microphone and converts into wav File
 * And Creates header information.
 *
 * @author Kevin Mark  Copyright 2016
 *https://gist.github.com/kmark/d8b1b01fb0d2febf5770
 */
public class RecordWavTask extends AsyncTask<File, Void, Object[]> {
    ...
    //Constructor that sets the context of the RecordWavTask Object
    ...
    //Getters for final Instance vars
    ...
    /**
     * Execute  Background tasks during enrollment file recording
     */
    ...
    protected Object[] doInBackground(File... files) {
        ...
        try {
            ...
            while (run && !isCancelled()) {
                ...
                if (total + read > 4294967295L) {
                    ...
                    // Write as many bytes as possible before hitting the max size
        ...
        try {
            ...
            // after closing the FileOutputStream
 ...
 */
    ...
    /**
     * After Enrollment wav file has been successfully Recorded.
     * @param results
     */
    protected void onPostExecute(Object[] results) {
        ...
        if (results[0] instanceof Throwable) {
            ...
            Log.e(RecordWavTask.class.getSimpleName(), throwable.getMessage(), throwable);
