 ...
 *
 *
 * This class allows the enrollment file created in WavRecorderActivity to be used to create a WavFile Object.
 * It extracts variables form the enrolment file and uses them to create a buffer of frames.
 * This also allows the individual
 *
...
public class WavFile
{
    ...
    /**
     *Constructor that sets the following parameters for the wavFile
     * and returns the wavFile
     *
     * @param file
     * @param numChannels
     * @param numFrames
    ...
    public static WavFile newWavFile(File file, int numChannels, long numFrames, int validBits, long sampleRate) throws IOException, WavFileException
    {
        ...
        // adjust the processEnrollmentWav chunk size
        ...
        // Set the processEnrollmentWav chunk size
    ...
    /**
     *Opens the wav file and reads it via input stream
     * @param file
     * @return
     * @throws "IOException"
     * @throws WavFileException
    ...
    /**
     * Return the number of frames read from buffer
     *
     * @param sampleBuffer
    ...
    /**
     * Returns the number frames left read from wavFile into a buffer
     *
     * @param sampleBuffer
     * @param numFramesToRead
     * @return
    ...
    /**
     * Returns no of frames to be written into buffer
     * @param sampleBuffer
    ...
    /**
     * Closes wavFile being read/written to,
     * @throws 'IOException'
     */
